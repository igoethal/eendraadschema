...
import { dosvgdownload, printsvg } from "./print/print";
...
export function printPDF(svg, print_table, properties, pages = [1], filename = "eendraadschema_print.pdf", statuscallback, sitplanprint) { // Defaults to A4 and 300 DPI but 600 DPI is better
...
declare global {
    interface Window {
        ...
        dosvgdownload: typeof dosvgdownload;
...
window.dosvgdownload = dosvgdownload;
