export const SITPLANVIEW_SELECT_PADDING: number = parseInt(getComputedStyle(document.documentElement).getPropertyValue('--selectPadding').trim());
export const SITPLANVIEW_ZOOMINTERVAL = { MIN: 0.1, MAX: 1000 };
export const SITPLANVIEW_DEFAULT_SCALE = 0.7;

export var CONFIGPAGE_LEFT: string = `
...
export var CONFIGPAGE_RIGHT: string = `
          <br><br>
        </td>
        <td width="25%" align="center">
          <br>
